...
class RainManager : MonoBehaviour 
{
	public float minYPosition 	 = 0.0f;	
	public float numberOfParticles	= 400.0f;
	...
	Mesh  CreateMesh () {
		...
		int particleNum = (int)(QualityManager.quality > Quality.Medium ? numberOfParticles : numberOfParticles / 2);
